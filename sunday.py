...
def job_sun9(chat_id):
    bot.send_message(chat_id, '🙋🏽‍♂Доброй ночи, надеюсь тебе понравилось! Теперь зможно приступить к регулярным online занятиям "ipractice.club!" и групповым занятям в классе')
#------------------------------------------------------------------------------------------------------------------------------
