...
def job_thu3():
    for assigned_chat in database.get_chats_for_schedule():
        bot.send_message(assigned_chat['id'], '🥛➕🥛➕🍋➕👌➕👌Выпейте стакан воды комнатной температуры натощак и за ним второй с щепоткой курскумы и чистым лимонным соком и содой.')
...
def job_thu6():
    for assigned_chat in database.get_chats_for_schedule():
        bot.send_message(assigned_chat['id'], '🌾➕🥗Гречка с овощами.\n'
                                              '\n'
...
def job_thu7():
    for assigned_chat in database.get_chats_for_schedule():
        bot.send_message(assigned_chat['id'], '🗓И конечно же помним, крайний прием пишщи до 18.00. Обнимаю)')
...
def job_thu9():
    for assigned_chat in database.get_chats_for_schedule():
        bot.send_message(assigned_chat['id'], '🙋🏽‍♂Доброй ночи, надеюсь тебе понравилось! Завтра ждет пятый день марафона и новая программа!')
