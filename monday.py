...
def job_mon4():
    for assigned_chat in database.get_chats_for_schedule():
      bot.send_message(assigned_chat['id'], 'САМОМАССАЖ СИДЯ + РАЗМИНКА СИДЯ')
