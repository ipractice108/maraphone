...
def job_mon4():
    for assigned_chat in database.get_chats_for_schedule():
      bot.send_message(assigned_chat['id'], 'https://youtu.be/cqP85i9NBUY')
      bot.send_message(assigned_chat['id'], 'Делаем все в комфортной скорости и комфортной амплитуде'
      bot.send_message(assigned_chat['id'], '➡️В 10.00 ты получишь нопоминание о режиме питания + рецепт завтрака')
...
def job_mon6():
    for assigned_chat in database.get_chats_for_schedule():
      bot.send_message(assigned_chat['id'], '🍚➕🥗Рис с овощами и рыбой.\n'
...
def job_mon7():
    for assigned_chat in database.get_chats_for_schedule():
      bot.send_message(assigned_chat['id'], 'https://youtu.be/tc8fIUumABM', '\n'
                         '\n'
...
def job_mon8():
    for assigned_chat in database.get_chats_for_schedule():
      bot.send_message(assigned_chat['id'], '🙋🏽‍♂️️Доброй ночи, надеюсь Вам понравилось! Завтра ждет второй день марафона и новая программа!')
