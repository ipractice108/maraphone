...
def job_wed6(chat_id):
    bot.send_message(chat_id, '🍘➕🥗Кус кус с овощами.\n'
                                              ...
                                              '\n'
                                              '🙏Пожалуйста постарайся воздержаться от еды начиная с 19.00. 		И да, конечно если вечером, перед сном ты выпьешь немного мятного или травяного чаю, с минимальным количеством натуральных сладостей, ничего критичного не произойдет. \n'
                                              '\n'
                                              '➡Вечером я пришлю  следующее видео с практикой.')

def job_wed66(chat_id):
    bot.send_message(chat_id,'https://youtu.be/5ZTdP-7OdpI')

# evening lesson
def job_wed7(chat_id):
    bot.send_message(chat_id, '🗓Напоминалочка, крайний прием пищи до 19.00')

def job_wed77(chat_id):
    bot.send_message(chat_id, '💪С едой на сегодня заканчиваем')
