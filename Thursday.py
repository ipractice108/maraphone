...
# THURSDAY SCHEDULE
    ...
    schedule.every(1).thursday.at("07:30").do(job_wed3)
    schedule.every(1).thursday.at("07:32").do(job_wed4)
    schedule.every(1).thursday.at("08:30").do(job_wed33)
    schedule.every(1).thursday.at("11:00").do(job_wed5)
    schedule.every(1).thursday.at("12:00").do(job_wed6)
    schedule.every(1).thursday.at("15:00").do(job_wed7)
    schedule.every(1).thursday.at("18:00").do(job_wed77)
    schedule.every(1).thursday.at("20:00").do(job_wed8)
    schedule.every(1).thursday.at("22:50").do(job_wed9)
    schedule.every(1).thursday.at("22:50").do(job_wed9)