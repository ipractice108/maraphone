...
def send_by_schedule():
    ...
    for assigned_chat in database.get_chats_for_schedule():
        ...
        logger.info('%s %s' % (calendar_day, user_time_srt))
        ...
        while True:
            ...
            try:
                if calendar_day == 'Monday':
                    ...
                    elif user_time_srt == "10:01": monday.job_mon55(assigned_chat['id'])
                    elif user_time_srt == "12:00": monday.job_mon6(assigned_chat['id'])
                    elif user_time_srt == "12:00": monday.job_mon66(assigned_chat['id'])
                ...
                if calendar_day == 'Tuesday':
                    ...
                    elif user_time_srt == "12:00": tuesday.job_tue66(assigned_chat['id'])
...
<<<<<<< HEAD
                if calendar_day == 'Wednsday':
                    ...
                    elif user_time_srt == "07:12": wednesday.job_wed33(assigned_chat['id'])
                    elif user_time_srt == "07:15": wednesday.job_wed4(assigned_chat['id'])
                    elif user_time_srt == "10:00": wednesday.job_wed5(assigned_chat['id'])
                    elif user_time_srt == "12:00": wednesday.job_wed6(assigned_chat['id'])
                    elif user_time_srt == "12:00": wednesday.job_wed66(assigned_chat['id'])
                    elif user_time_srt == "15:00": wednesday.job_wed7(assigned_chat['id'])
...
>>>>>>> 046e40d28fe640c521423c73cfda72081c066097
                ...
                if calendar_day == 'Thursday':
                    ...
                    elif user_time_srt == "12:00": thursday.job_thu66(assigned_chat['id'])
                    elif user_time_srt == "15:00": thursday.job_thu7(assigned_chat['id'])
                    elif user_time_srt == "18:00": thursday.job_thu77(assigned_chat['id'])
                ...
                if calendar_day == 'Friday':
                    ...
                    elif user_time_srt == "10:01": friday.job_fri55(assigned_chat['id'])
                    elif user_time_srt == "12:00": friday.job_fri6(assigned_chat['id'])
                    elif user_time_srt == "12:00": friday.job_fri66(assigned_chat['id'])
                    elif user_time_srt == "15:00": friday.job_fri7(assigned_chat['id'])
                    elif user_time_srt == "18:00": friday.job_fri77(assigned_chat['id'])
                ...
                if calendar_day == 'Saturday':
                    ...
                    elif user_time_srt == "12:00": saturday.job_sat66(assigned_chat['id'])
                ...
                if calendar_day == 'Sunday':
                    ...
                    elif user_time_srt == "10:01": sunday.job_sun55(assigned_chat['id'])
                    elif user_time_srt == "10:02": sunday.job_sun555(assigned_chat['id'])
                    elif user_time_srt == "10:03": sunday.job_sun5555(assigned_chat['id'])
